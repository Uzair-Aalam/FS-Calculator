...
class App(tk.Tk):
    ...
    def Window11(self):
        ...
        self.photo1 = tk.PhotoImage(file="./Pictures/slopeCondition1.gif")
        ...
        self.photo2 = tk.PhotoImage(file="./Pictures/slopeCondition2.gif")
        ...
        self.photo3 = tk.PhotoImage(file="./Pictures/slopeCondition3.gif")
        ...
        self.photo4 = tk.PhotoImage(file="./Pictures/slopeCondition4.gif")
        ...
        self.photo5 = tk.PhotoImage(file="./Pictures/slopeCondition5.gif")
    ...
    def About(self):
        print('''Developer : Uzair Aalam
                 Contact : uaalam[at]myamu[dot]ac[dot]in''')
    def Licence(self):
            '''Licenced under ....'''
    def setIcon(self,windowObject):
        try:
            windowObject.iconbitmap(r'./Pictures/icon1.ico')
        except:
